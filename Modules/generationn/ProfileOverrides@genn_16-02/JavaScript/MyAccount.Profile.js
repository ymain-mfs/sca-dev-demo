	...
	,	mountToApp: function (application)
		{
			...
			// Place bootstrapped widgets into profile model			
			if (SC.ENVIRONMENT.WIDGET)
			{
				profile_model_instance.get('widgets').reset(SC.ENVIRONMENT.WIDGET);
				delete SC.ENVIRONMENT.WIDGET;
			}
			else
			{
				profile_model_instance.get('widgets').reset([]);
			}
