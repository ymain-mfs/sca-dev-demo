define('Widget.Model', ['SC.Model', 'Application'], function (SCModel, Application)
{
    ...
    ,   listCoded: function ()
        {
            ...
            search = nlapiCreateSearch('customrecord_gen_widget', null, columns);
    ...
    ,   create: function(data) {
            ...
            // get id of logged in shopper and set into widget record object
            var customerFields = customer.getFieldValues(['internalid']);
            console.log('Customer Fields', JSON.stringify(customerFields.internalid));
